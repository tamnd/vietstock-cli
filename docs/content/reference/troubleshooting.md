...
Most of these come down to network reality or how vietstock serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

vietstock rate-limits like any public site. vietstock already paces
...
Where a surface is gated, vietstock reads a cookie or token you supply
...
`vietstock`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what vietstock actually did
