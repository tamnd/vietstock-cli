...
```
vietstock <command> [arguments] [flags]
```

Run `vietstock <command> --help` for the full flag list on any command. This
...
per operation you declare in `vietstock/domain.go`.
